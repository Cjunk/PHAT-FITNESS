...
var BAD_CREDENTIALS = "BAD CREDENTIALS";
var BAD_CREDENTIALS_STATUS = 403;
...
router.post("/login", function (req, res) {
    ...
    */
    db.query("SELECT email,username,users.id,firstname,hashed_password FROM ".concat(USERS_TABLE_NAME, " JOIN hashed_passwords ON users.id = hashed_passwords.id WHERE email = $1;"), [email])
        .then(function (dbres) {
...
router.get(["/", "/anthing"], function (req, res) {
